...
mass properties list to "+". This convention determines how products of
inertia are saved to a data set.

The signature of `set_poi_conv_plus()` is such that it can be passed as
...
thus ensuring that calculated POI values are saved using the positive
integral convention.
