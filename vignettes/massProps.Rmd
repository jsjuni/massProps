...
Let ${p_X}_i$, ${p_Y}_i$, and ${p_Z}_i$ be the respective diagonal elements of $P_i$. Let $\boldsymbol{1}_3$ be the $3x3$ identity matrix. If we interpret squaring a matrix as the Hadamard (element-wise) product with itself, then $$
\begin{align}
