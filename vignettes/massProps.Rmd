...
\boldsymbol{s}_i & = \boldsymbol{I}_i - w_i \begin{bmatrix}
                 ...
                 & = \boldsymbol{I}_i - w_i \begin{bmatrix}
                                              ...
                                              \end{bmatrix} \\
                 & \mathrel{\hphantom{=}} \hphantom{\boldsymbol{I}_i} - w_i \begin{bmatrix}
...
\end{bmatrix}^2 \\
& \mathrel{\hphantom{=}} \hphantom{{\boldsymbol{\sigma_I}}_i^2} +
\begin{bmatrix}
...
\end{bmatrix}
\right) ^2 \\
& \mathrel{\hphantom{=}} \hphantom{{\boldsymbol{\sigma_I}}_i^2} + w_i^2 \left(
\boldsymbol{P}_i^T -
\begin{bmatrix}
...
\end{bmatrix}
\right) ^2 \\
& \mathrel{\hphantom{=}} \hphantom{{\boldsymbol{\sigma_I}}_i^2} + \sigma_{w_i}^2 \left(
